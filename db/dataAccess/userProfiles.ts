...
export async function updateUserProfile ( userId: string, updates: Partial<typeof userProfiles.$inferSelect> & { email?: string } )
{
  try
  {
...
export async function updateUserStripeConnect ( userId: string, stripeData: {
