...
export const customers = pgTable('customers', {
  id: uuid('id').primaryKey().default(sql`uuid_generate_v4()`),
  orgPaymentId: uuid('org_payment_id').notNull().references(() => orgPayments.id), // Reference to org_payments
  name: text('name').notNull(),
...
export const tickets = pgTable('tickets', {
  ...
  orgId: uuid('org_id').notNull().references(() => organizations.id), // Reference to organizations
  customerId: uuid('customer_id').notNull().references(() => customers.id), // Reference to customers
  name: text('name').notNull(),
