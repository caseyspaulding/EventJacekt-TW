    ...
    <section className="py-16 ">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          <a
            href="/signup"
            className="inline-flex items-center px-6 py-3 text-xl font-medium text-white bg-blue-500 border border-transparent rounded-3xl shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            Get Started
