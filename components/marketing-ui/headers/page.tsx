  ...
  return (
    <>
      ...
      <BlockSection
        ...
        description="This example can be often used if you want to highlight the branding of your EventJacket by placing the logo in the center of the navbar and the menu on the left side."
