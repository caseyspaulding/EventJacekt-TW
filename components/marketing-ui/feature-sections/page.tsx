  ...
  return (
    <>
      <BlockBreadcrumb
        ...
        description="Get started with a collection of responsive website sections built with Tailwind CSS to showcase a list of features that your product or EventJacket offers."
      />
      <BlockSection
