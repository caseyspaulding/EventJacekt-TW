...
import { ContactFormWithEventJacketInformation } from "./EventJacket-information";
  ...
  return (
    <>
      ...
      <BlockSection
        ...
        description="Use this example of a contact form where you can also provide information about your EventJacket's headquarters and phone number."
      ...
      <BlockSection
        title="Contact form with EventJacket information"
        description="Use this contact form to show information about your EventJacket such as the legal name, tax id, phone number, and also a form where your clients can get in contact."
        githubLink="https://github.com/themesberg/flowbite-react-blocks/blob/main/pages/marketing-ui/contact-forms/EventJacket-information.tsx"
      >
        <ContactFormWithEventJacketInformation />
      </BlockSection>
    </>
  );
}
