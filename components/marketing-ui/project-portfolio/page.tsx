...
export default function AllProjectPortfolio ()
{
  return (
    <>
      <BlockBreadcrumb
        title="Portfolio"
        description="Get started with the project portfolio components to showcase your personal or EventJacket client's project specifications, previews and results coded with Tailwind CSS."
      />
      <BlockSection
        title="Default portfolio example"
        description="Use this example to show a list of EventJacket clients and case study previews inside a website section featuring the client, title of the project, a description and CTA button."
