  ...
  return (
    <>
      ...
      <BlockSection
        ...
        description="Use this example to first show multiple address locations of your EventJacket, a newsletter sign-up form, the logo of your brand, language selector, and copyright notice."
