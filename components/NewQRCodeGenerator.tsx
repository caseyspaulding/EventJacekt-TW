...
export default function NewQRCodeGenerator ()
{
  ...
  return (
    <><div className='app mt-20 flex justify-center items-center '>
<h1 className='text-4xl font-extrabold'>Free QR Code Generator</h1>
    </div><div className='app mt-20 flex justify-center items-center h-screen'>
        ...
        <div style={ { display: 'flex', flexDirection: 'row', flexWrap: 'wrap' } }>
          ...
          <div style={ {
            ...
            <button
              ...
              className="mt-5 mb-5 ml-5 mr-5 px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"
            >
              Download QR Code
            </button>
          </div>
