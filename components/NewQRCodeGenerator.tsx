  ...
  return (
    <>
      <div className='app mt-10 flex justify-center items-center'>
        <h1 className='text-4xl font-extrabold text-center'>Free QR Code Generator</h1>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4">
        <div className="w-full p-4 space-y-8">
          ...
          <div className="w-full flex justify-center p-4">
            <div className="w-full md:w-3/4 lg:w-1/2 flex flex-col items-center border border-blue-600 rounded-3xl bg-blue-600 p-4">
              <QRCode
