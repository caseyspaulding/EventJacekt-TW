...
export default function ShareModal ( { eventName }: ShareModalProps )
{
  ...
  const shareButtons = [
    ...
    { name: 'Messenger', icon: faFacebookMessenger, url: `https://www.facebook.com/dialog/send?link=${ encodeURIComponent( currentUrl ) }&app_id=YOUR_APP_ID&message=${ encodeURIComponent( `Join me at ${ eventName }` ) }` },
