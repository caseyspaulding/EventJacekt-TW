          ...
          <form action="#">
            <div className="mb-4 grid gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <TextInput
                  defaultValue="leslie@EventJacket.com"
                  id="email"
                  name="email"
                  placeholder="bonnie@EventJacket.com"
                  required
                  type="email"
                />
              </div>
                ...
                <Accordion.Content className="dark:bg-gray-800">
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <TextInput
                        defaultValue="bonnie.green@EventJacket.com"
                        id="email"
                        name="email"
                        placeholder="john@EventJacket.com"
                        required
                        type="email"
                      />
                    </div>
