...
const ECommerceInvoicePageContent: FC<ECommerceInvoicePageData> = function ({ invoice }) {
    return (
        <>
            <Menu />
...
const Invoice: FC<ECommerceInvoicePageData> = function ({ invoice }) {
    return (
                        ...
                        <div className="overflow-hidden shadow">
                            <Table className="min-w-full text-gray-900">
                                <Table.Head
                                    ...
                                    theme={{
                                        cell: {
                                            base: 'p-4 text-left text-xs font-semibold uppercase tracking-wider first-of-type:rounded-l-lg last-of-type:rounded-r-lg'
                                        }
                                    }}
                                >
