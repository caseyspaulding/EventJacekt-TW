...
const MailingInboxPageContent: FC<MailingInboxPageData> = function ({ inboxMessages }) {
    return (
        <>
...
const Menu: FC<MailingInboxPageData> = function ({ inboxMessages }) {
...
const Inbox: FC<MailingInboxPageData> = function ({ inboxMessages }) {
