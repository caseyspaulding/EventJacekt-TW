...
const MailingReplyPage: NextPage = function () {
    return (
        <>
            <Menu />
            <div className="p-5">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                        ...
                        acceptance collecting frequently be if. Zealously now pronounce existence
                        add you instantly say offending. Merry their far had widen was. Concerns no
                        in expenses raillery formerly.
                    </p>
                    <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                        Best Regards,
                        <br />
    ...
    return (
        <div className="block items-center justify-between border-b border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800 sm:flex">
            <div className="flex items-center divide-x divide-gray-100 dark:divide-gray-700">
                ...
                <div className="pl-3 text-sm font-medium text-gray-500 dark:text-gray-400">
                    Today, 08:34 AM
                </div>
            </div>
