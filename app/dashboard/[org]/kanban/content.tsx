                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <div className="flex justify-between">
                                                    ...
                                                    <div className="flex items-center justify-center rounded-lg bg-purple-100 px-3 text-sm font-medium text-purple-800 dark:bg-purple-200">
                                                        <HiClock className="mr-1 h-4 w-4" /> 7 days
                                                        left
                                                    </div>
                                                </div>
                                            </div>
                ...
                <Modal.Body>
                    ...
                    <div className="mb-4 space-y-2 text-base text-gray-500 dark:text-gray-400">
                        <p>
                            ...
                            building it in Google’s Material Design (Please learn more about this
                            and see how to improve standard material design into something
                        ...
                        <p>
                            ...
                            iteration. Make sure, we have a good result to be delivered by the day.
                        </p>
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        <ul className="list-outside list-disc pl-6 text-xs text-gray-500 dark:text-gray-400">
                            <li>
                                ...
                                merchant, we should instead have a logo that represent the referring
                                traffic sources (ex. Google or Facebook). So we’re actually missing
                                a column that should say “Source”. And there should be no icon for
                                the merchants.
                            </li>
                        </ul>
                    </div>
