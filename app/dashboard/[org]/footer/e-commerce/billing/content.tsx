...
const ECommerceBillingPageContent: FC<ECommerceBillingPageData> = function ({
    nextPayment,
    orderHistory
}) {
    return (
...
const IntroCard: FC<Pick<ECommerceBillingPageData, 'nextPayment'>> = function ({ nextPayment }) {
    return (
        <Card>
            <Link
                href="#"
...
const OrderHistoryCard: FC<Pick<ECommerceBillingPageData, 'orderHistory'>> = function ({
    orderHistory
}) {
    return (
        <Card>
