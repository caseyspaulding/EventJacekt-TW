...
const CreateTicketsPage = () => {
    ...
    return (
        <div className="mx-auto max-w-3xl rounded-lg bg-white p-8 shadow-md">
            <h1 className="mb-6 text-center text-2xl font-bold">Create Tickets for Event</h1>
            <p className="text-center text-gray-600">
                Fill in the details below to create a new ticket type for your event. This defines
                the different types of tickets available for an event, such as general admission,
                VIP, or early bird.{' '}
                <p>
                    It stores the attributes related to each type, like price, quantity, and sale
                    dates. This table allows you to manage and configure ticket types independently
                    of the actual tickets sold.
                </p>{' '}
                You can create multiple ticket types for an event, each with its own set of
                attributes.
            </p>
            ...
            {isModalOpen && (
                <ModalEventCreation onClose={() => setIsModalOpen(false)}>
                    <div>
                        ...
                        <p>
                            Your ticket types for the event have been created. You can now share the
                            event page with your audience.
                        </p>
