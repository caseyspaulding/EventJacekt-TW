      ...
      <div className="flex h-screen flex-col items-center justify-center px-4">
        ...
        <div className="flex flex-row justify-center gap-6 mt-6">
          <Button
            ...
            className="flex flex-col items-center justify-center w-24 h-24 bg-blue-500 hover:bg-green-600 text-white shadow-2xl"
          ...
          <Button
            ...
            className="flex flex-col items-center shadow-2xl justify-center w-24 h-24 bg-blue-500 hover:bg-green-600 text-white"
          >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={ 1.5 } stroke="currentColor" className="size-8">
