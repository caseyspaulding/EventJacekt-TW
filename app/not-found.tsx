...
const links = [
    ...
    { name: 'Blog', href: '/blog', description: 'Read our latest news and articles.', icon: RssIcon },
]
const social = [
    {
        name: 'X',
        ...
        <div className="bg-white">
            <main className="mx-auto w-full max-w-7xl px-6 pb-16 pt-10 sm:pb-24 lg:px-8">
                ...
                <div className="mx-auto mt-10 max-w-2xl text-center sm:mt-14">
                    ...
                    <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Ah Snap!</h1>
            ...
            <footer className="border-t border-gray-100 py-6 sm:py-10">
                <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-8 px-6 sm:flex-row lg:px-8">
                    <p className="text-sm leading-7 text-gray-400">&copy; EventJacket, Inc. All rights reserved.</p>
